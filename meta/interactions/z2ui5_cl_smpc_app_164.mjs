...
export default async (page, expect) => {
  ...
  await waitForUi5(page, modeIs('Fixed'), 'the table did not boot in the seeded Fixed row mode');
  ...
  await waitForUi5(page, modeIs('Auto'), 'picking Auto did not switch the Table rowMode through the shared bound field');
};
