...
" @origin sap.uxap.sample.ObjectPageBeforeNavigate - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageBeforeNavigate (status: generated - machine-written, not yet reviewed)
