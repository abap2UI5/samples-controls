...
" @origin sap.uxap.sample.ObjectPageTitleOnLeft - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageTitleOnLeft (status: reviewed - read against the original, not run)
