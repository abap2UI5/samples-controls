...
" @origin sap.uxap.sample.AnchorBarWithNumbers - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.AnchorBarWithNumbers (status: generated - machine-written, not yet reviewed)
