...
" @origin sap.uxap.sample.ObjectPageWithHeaderContainer - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.ObjectPageWithHeaderContainer (status: reviewed - read against the original, not run)
