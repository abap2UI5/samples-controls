...
" @origin sap.tnt.sample.ToolHeaderIconTabHeader - https://sdk.openui5.org/entity/sap.tnt.ToolHeader/sample/sap.tnt.sample.ToolHeaderIconTabHeader (status: reviewed - read against the original, not run)
