...
" @origin sap.tnt.sample.SideNavigationWrapping - https://sdk.openui5.org/entity/sap.tnt.SideNavigation/sample/sap.tnt.sample.SideNavigationWrapping (status: reviewed - read against the original, not run)
