...
" @origin sap.ui.table.sample.OData - https://sdk.openui5.org/entity/sap.ui.table.Table/sample/sap.ui.table.sample.OData (status: reviewed - read against the original, not run)
