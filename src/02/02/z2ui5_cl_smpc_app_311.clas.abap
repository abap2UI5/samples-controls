...
" @origin sap.ui.unified.sample.MenuSelectable - https://sdk.openui5.org/entity/sap.ui.unified.Menu/sample/sap.ui.unified.sample.MenuSelectable (status: reviewed - read against the original, not run)
