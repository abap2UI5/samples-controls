...
" @origin sap.ui.unified.sample.MenuItemEventing - https://sdk.openui5.org/entity/sap.ui.unified.Menu/sample/sap.ui.unified.sample.MenuItemEventing (status: reviewed - read against the original, not run)
