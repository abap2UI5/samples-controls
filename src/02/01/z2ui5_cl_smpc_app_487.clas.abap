...
" @origin sap.m.sample.PanelSticky - https://sdk.openui5.org/entity/sap.m.Panel/sample/sap.m.sample.PanelSticky (status: generated - machine-written, not yet reviewed)
