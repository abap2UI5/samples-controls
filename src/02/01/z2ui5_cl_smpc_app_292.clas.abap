...
" @origin sap.m.sample.PanelBackgroundDesign - https://sdk.openui5.org/entity/sap.m.Panel/sample/sap.m.sample.PanelBackgroundDesign (status: reviewed - read against the original, not run)
