...
CLASS z2ui5_cl_smpc_app_294 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    DATA top TYPE string.
    DATA s_message LIKE LINE OF t_messages.
    DATA temp5 TYPE i.
    DATA x TYPE i.
    DATA s_row LIKE LINE OF t_messages.
      DATA temp1 TYPE i.
    desc = `First Error message description. ` && |\n| &&
    ...
    LOOP AT t_messages INTO s_message.
      CASE s_message-type.
        WHEN `Error`.
          top = `Error`.
        WHEN `Warning`.
