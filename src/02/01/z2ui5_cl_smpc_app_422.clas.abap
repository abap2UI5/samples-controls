...
" @origin sap.m.sample.SelectDialogLazyLoading - https://sdk.openui5.org/entity/sap.m.SelectDialog/sample/sap.m.sample.SelectDialogLazyLoading (status: generated - machine-written, not yet reviewed)
