...
" @origin sap.m.sample.ObjectNumber - https://sdk.openui5.org/entity/sap.m.ObjectNumber/sample/sap.m.sample.ObjectNumber (status: reviewed - read against the original, not run)
