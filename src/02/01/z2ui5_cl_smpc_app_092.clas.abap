...
" @origin sap.m.sample.TableAutoPopin - https://sdk.openui5.org/entity/sap.m.Table/sample/sap.m.sample.TableAutoPopin (status: reviewed - read against the original, not run)
...
CLASS z2ui5_cl_smpc_app_092 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    temp4-maincategory = `Computer Systems`.
    ...
    temp4-maincategory = `Computer Components`.
    ...
    temp4-maincategory = `Printers & Scanners`.
    ...
    temp4-maincategory = `Smartphones & Tablets`.
    temp4-suppliername = `Ultrasonic United`.
    ...
    temp4-category = `Accessories`.
    temp4-maincategory = `TV, Video & HiFi`.
    temp4-suppliername = `Titanium`.
