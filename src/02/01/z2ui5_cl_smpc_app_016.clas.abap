...
" @origin sap.m.sample.DatePickerHidden - https://sdk.openui5.org/entity/sap.m.DatePicker/sample/sap.m.sample.DatePickerHidden (status: checked - verified in a running system)
