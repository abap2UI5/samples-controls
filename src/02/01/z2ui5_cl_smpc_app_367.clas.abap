...
" @origin sap.m.sample.InputDescription - https://sdk.openui5.org/entity/sap.m.Input/sample/sap.m.sample.InputDescription (status: reviewed - read against the original, not run)
