...
" @origin sap.m.sample.RadioButton - https://sdk.openui5.org/entity/sap.m.RadioButton/sample/sap.m.sample.RadioButton (status: reviewed - read against the original, not run)
