...
CLASS z2ui5_cl_smpc_app_094 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    temp10-quantity = `10`.
    temp10-uom = `PC`.
    temp10-weightmeasure = `4.2`.
    temp10-weightunit = `KG`.
    temp10-price = '956.00'.
