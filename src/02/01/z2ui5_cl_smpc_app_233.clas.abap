...
CLASS z2ui5_cl_smpc_app_233 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    temp2 = `$event.oSource.getValue() ? '[[["PURCHASEID","Contains","' + $event.oSource.getValue() + '"],["SUPPLIERNAME","Contains","' + $event.oSource.getValue() + '"]]]' : ` && `'[]'`.
  ...
  METHOD on_event.
    ...
    CASE client->get_event( ).
      ...
      WHEN `VH_SEARCH`.
        ...
        temp5 = |[[["PURCHASEID","Contains","{ search_value }"],["SUPPLIERNAME","Contains","{ search_value }"]]]|.
