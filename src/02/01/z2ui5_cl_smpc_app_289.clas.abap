...
" @origin sap.m.sample.DynamicMessageStripGenerator - https://sdk.openui5.org/entity/sap.m.MessageStrip/sample/sap.m.sample.DynamicMessageStripGenerator (status: reviewed - read against the original, not run)
