...
" @origin sap.f.sample.FlexibleColumnLayoutWithOneColumnStart - https://sdk.openui5.org/entity/sap.f.FlexibleColumnLayout/sample/sap.f.sample.FlexibleColumnLayoutWithOneColumnStart (status: generated - machine-written, not yet reviewed)
...
CLASS z2ui5_cl_smpc_app_579 IMPLEMENTATION.
  ...
  METHOD on_event.
        DATA query TYPE string.
          DATA temp7 TYPE z2ui5_cl_smpc_app_579=>ty_t_product.
  ...
  METHOD model_init.
    ...
    DATA temp28 TYPE z2ui5_cl_smpc_app_579=>ty_t_product.
    DATA temp29 LIKE LINE OF temp28.
    DATA temp30 TYPE z2ui5_cl_smpc_app_579=>ty_t_supplier.
