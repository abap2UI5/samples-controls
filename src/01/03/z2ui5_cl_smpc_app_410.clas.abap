...
" @origin sap.uxap.sample.BlockBaseEventing - https://sdk.openui5.org/entity/sap.uxap.BlockBase/sample/sap.uxap.sample.BlockBaseEventing (status: reviewed - read against the original, not run)
