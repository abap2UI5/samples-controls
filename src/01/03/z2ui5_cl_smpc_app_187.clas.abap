...
" @origin sap.uxap.sample.AnchorBarNoPopover - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.AnchorBarNoPopover (status: reviewed - read against the original, not run)
