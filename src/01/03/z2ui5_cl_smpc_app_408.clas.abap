...
" @origin sap.uxap.sample.ObjectPageBlockBase - https://sdk.openui5.org/entity/sap.uxap.BlockBase/sample/sap.uxap.sample.ObjectPageBlockBase (status: reviewed - read against the original, not run)
