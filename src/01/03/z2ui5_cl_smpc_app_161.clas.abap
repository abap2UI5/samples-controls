...
" @origin sap.uxap.sample.SingleView - https://sdk.openui5.org/entity/sap.uxap.ObjectPageLayout/sample/sap.uxap.sample.SingleView (status: reviewed - read against the original, not run)
