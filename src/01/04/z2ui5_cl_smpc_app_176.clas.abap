...
" @origin sap.f.sample.GridListBoxContainerGrouping - https://sdk.openui5.org/entity/sap.f.GridList/sample/sap.f.sample.GridListBoxContainerGrouping (status: reviewed - read against the original, not run)
