...
" @origin sap.f.sample.FlexibleColumnLayoutSimple - https://sdk.openui5.org/entity/sap.f.FlexibleColumnLayout/sample/sap.f.sample.FlexibleColumnLayoutSimple (status: reviewed - read against the original, not run)
