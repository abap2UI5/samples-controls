...
" @origin sap.m.sample.FlexBoxOpposingAlignment - https://sdk.openui5.org/entity/sap.m.FlexBox/sample/sap.m.sample.FlexBoxOpposingAlignment (status: reviewed - read against the original, not run)
