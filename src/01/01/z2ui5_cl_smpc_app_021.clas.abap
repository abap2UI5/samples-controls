...
" @origin sap.m.sample.DraftIndicator - https://sdk.openui5.org/entity/sap.m.DraftIndicator/sample/sap.m.sample.DraftIndicator (status: checked - verified in a running system)
