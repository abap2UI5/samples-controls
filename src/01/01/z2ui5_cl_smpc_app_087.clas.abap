...
" @origin sap.m.sample.ContainerNoPadding - https://sdk.openui5.org/entity/sap.ui.core.ContainerPadding/sample/sap.m.sample.ContainerNoPadding (status: reviewed - read against the original, not run)
