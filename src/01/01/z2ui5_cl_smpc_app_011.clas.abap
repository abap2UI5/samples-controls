...
" @origin sap.m.sample.ComboBox - https://sdk.openui5.org/entity/sap.m.ComboBox/sample/sap.m.sample.ComboBox (status: reviewed - read against the original, not run)
