...
" @origin sap.m.sample.ToolbarVsBar - https://sdk.openui5.org/entity/sap.m.Bar/sample/sap.m.sample.ToolbarVsBar (status: reviewed - read against the original, not run)
