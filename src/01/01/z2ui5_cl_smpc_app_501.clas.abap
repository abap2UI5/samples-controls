...
" @origin sap.m.sample.MultiInputValidators - https://sdk.openui5.org/entity/sap.m.MultiInput/sample/sap.m.sample.MultiInputValidators (status: generated - machine-written, not yet reviewed)
