...
" @origin sap.m.sample.TextMaxLines - https://sdk.openui5.org/entity/sap.m.Text/sample/sap.m.sample.TextMaxLines (status: reviewed - read against the original, not run)
