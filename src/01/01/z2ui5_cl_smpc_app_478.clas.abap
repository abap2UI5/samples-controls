...
" @origin sap.m.sample.MultiInputCustomFiltering - https://sdk.openui5.org/entity/sap.m.MultiInput/sample/sap.m.sample.MultiInputCustomFiltering (status: generated - machine-written, not yet reviewed)
