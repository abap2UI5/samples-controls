...
" @origin sap.m.sample.SelectListWithIcons - https://sdk.openui5.org/entity/sap.m.SelectList/sample/sap.m.sample.SelectListWithIcons (status: reviewed - read against the original, not run)
