...
" @origin sap.m.sample.StandardListItemDescription - https://sdk.openui5.org/entity/sap.m.StandardListItem/sample/sap.m.sample.StandardListItemDescription (status: reviewed)
