...
" @origin sap.m.sample.IconTabBar - https://sdk.openui5.org/entity/sap.m.IconTabBar/sample/sap.m.sample.IconTabBar (status: reviewed - read against the original, not run)
