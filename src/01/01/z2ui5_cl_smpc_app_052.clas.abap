" @keywords textarea text area sap.m allows enter multi-line verticallayout
...
" @origin sap.m.sample.TextArea - https://sdk.openui5.org/entity/sap.m.TextArea/sample/sap.m.sample.TextArea (status: reviewed - read against the original, not run)
