...
" @origin sap.m.sample.DialogConfirm - https://sdk.openui5.org/entity/sap.m.Dialog/sample/sap.m.sample.DialogConfirm (status: checked - verified in a running system)
