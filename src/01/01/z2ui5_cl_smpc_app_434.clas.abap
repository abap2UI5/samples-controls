...
" @origin sap.m.sample.ContainerPadding - https://sdk.openui5.org/entity/sap.ui.core.ContainerPadding/sample/sap.m.sample.ContainerPadding (status: generated - machine-written, not yet reviewed)
