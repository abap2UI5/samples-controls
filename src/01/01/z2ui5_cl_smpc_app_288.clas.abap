...
" @origin sap.m.sample.PDFViewerEmbedded - https://sdk.openui5.org/entity/sap.m.PDFViewer/sample/sap.m.sample.PDFViewerEmbedded (status: reviewed - read against the original, not run)
