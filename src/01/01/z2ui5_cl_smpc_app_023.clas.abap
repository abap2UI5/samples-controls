...
" @origin sap.m.sample.FeedContent - https://sdk.openui5.org/entity/sap.m.FeedContent/sample/sap.m.sample.FeedContent (status: checked - verified in a running system)
