...
" @origin sap.m.sample.ObjectHeaderImage - https://sdk.openui5.org/entity/sap.m.ObjectHeader/sample/sap.m.sample.ObjectHeaderImage (status: reviewed - read against the original, not run)
