...
" @origin sap.m.sample.FormattedText - https://sdk.openui5.org/entity/sap.m.FormattedText/sample/sap.m.sample.FormattedText (status: reviewed - read against the original, not run)
