...
" @origin sap.m.sample.ViewSettingsDialog - https://sdk.openui5.org/entity/sap.m.ViewSettingsDialog/sample/sap.m.sample.ViewSettingsDialog (status: reviewed - read against the original, not run)
