...
" @origin sap.m.sample.NewsContent - https://sdk.openui5.org/entity/sap.m.NewsContent/sample/sap.m.sample.NewsContent (status: reviewed - read against the original, not run)
