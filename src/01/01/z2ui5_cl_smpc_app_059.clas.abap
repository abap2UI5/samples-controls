...
" @origin sap.m.sample.LightBox - https://sdk.openui5.org/entity/sap.m.LightBox/sample/sap.m.sample.LightBox (status: reviewed - read against the original, not run)
...
CLASS z2ui5_cl_smpc_app_059 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    lorem = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum lectus et tempus blandit. Sed porta ex quis tortor gravida, ut suscipit felis ` &&
