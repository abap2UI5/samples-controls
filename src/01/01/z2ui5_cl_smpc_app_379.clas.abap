...
" @origin sap.m.sample.IconTabBarInlineMode - https://sdk.openui5.org/entity/sap.m.IconTabBar/sample/sap.m.sample.IconTabBarInlineMode (status: reviewed - read against the original, not run)
