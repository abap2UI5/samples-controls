...
" @origin sap.m.sample.CookieSettingsDialogPattern - https://sdk.openui5.org/entity/sap.m.CookieSettingsDialogPattern/sample/sap.m.sample.CookieSettingsDialogPattern (status: checked - verified in a running system)
