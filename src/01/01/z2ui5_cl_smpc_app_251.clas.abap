...
" @origin sap.m.sample.BusyDialogLight - https://sdk.openui5.org/entity/sap.m.BusyDialog/sample/sap.m.sample.BusyDialogLight (status: reviewed - read against the original, not run)
