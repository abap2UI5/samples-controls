...
" @origin sap.m.sample.HeaderContainer - https://sdk.openui5.org/entity/sap.m.HeaderContainer/sample/sap.m.sample.HeaderContainer (status: reviewed - read against the original, not run)
