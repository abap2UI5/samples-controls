...
" @origin sap.m.sample.TextRenderWhitespace - https://sdk.openui5.org/entity/sap.m.Text/sample/sap.m.sample.TextRenderWhitespace (status: generated - machine-written, not yet reviewed)
