...
" @origin sap.m.sample.MultiInputValueStates - https://sdk.openui5.org/entity/sap.m.MultiInput/sample/sap.m.sample.MultiInputValueStates (status: reviewed - read against the original, not run)
