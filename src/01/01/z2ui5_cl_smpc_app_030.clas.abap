...
" @origin sap.m.sample.IconTabBarStretchContent - https://sdk.openui5.org/entity/sap.m.IconTabBar/sample/sap.m.sample.IconTabBarStretchContent (status: checked - verified in a running system)
