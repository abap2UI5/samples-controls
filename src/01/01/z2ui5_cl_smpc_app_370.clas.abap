...
" @origin sap.m.sample.TextAreaGrowing - https://sdk.openui5.org/entity/sap.m.TextArea/sample/sap.m.sample.TextAreaGrowing (status: reviewed - read against the original, not run)
