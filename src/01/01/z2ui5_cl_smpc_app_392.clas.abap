...
" @origin sap.m.sample.FlexBoxBasicAlignment - https://sdk.openui5.org/entity/sap.m.FlexBox/sample/sap.m.sample.FlexBoxBasicAlignment (status: reviewed - read against the original, not run)
