...
" @origin sap.m.sample.StandardMarginsTwoSided - https://sdk.openui5.org/entity/sap.ui.core.StandardMargins/sample/sap.m.sample.StandardMarginsTwoSided (status: generated - machine-written, not yet reviewed)
