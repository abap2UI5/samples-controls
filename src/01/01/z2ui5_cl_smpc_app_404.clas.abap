...
" @origin sap.m.sample.TimePickerValueState - https://sdk.openui5.org/entity/sap.m.TimePicker/sample/sap.m.sample.TimePickerValueState (status: reviewed - read against the original, not run)
