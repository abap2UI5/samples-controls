...
" @origin sap.m.sample.ObjectAttributeInTable - https://sdk.openui5.org/entity/sap.m.ObjectAttribute/sample/sap.m.sample.ObjectAttributeInTable (status: reviewed - read against the original, not run)
