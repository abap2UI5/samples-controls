...
" @origin sap.m.sample.ToolbarDesign - https://sdk.openui5.org/entity/sap.m.OverflowToolbar/sample/sap.m.sample.ToolbarDesign (status: reviewed - read against the original, not run)
