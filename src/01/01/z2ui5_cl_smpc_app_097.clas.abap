...
" @origin sap.m.sample.SplitApp - https://sdk.openui5.org/entity/sap.m.SplitApp/sample/sap.m.sample.SplitApp (status: reviewed - read against the original, not run)
