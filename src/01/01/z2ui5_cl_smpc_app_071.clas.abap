...
" @origin sap.m.sample.ObjectIdentifier - https://sdk.openui5.org/entity/sap.m.ObjectIdentifier/sample/sap.m.sample.ObjectIdentifier (status: reviewed - read against the original, not run)
