...
" @origin sap.m.sample.SegmentedButtonVSD - https://sdk.openui5.org/entity/sap.m.SegmentedButton/sample/sap.m.sample.SegmentedButtonVSD (status: generated - machine-written, not yet reviewed)
