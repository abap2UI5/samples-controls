...
" @origin sap.ui.layout.sample.FixFlexHorizontal - https://sdk.openui5.org/entity/sap.ui.layout.FixFlex/sample/sap.ui.layout.sample.FixFlexHorizontal (status: reviewed - read against the original, not run)
