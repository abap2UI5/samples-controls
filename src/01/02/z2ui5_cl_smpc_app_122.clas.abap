...
" @origin sap.ui.core.sample.Icon - https://sdk.openui5.org/entity/sap.ui.core.Icon/sample/sap.ui.core.sample.Icon (status: reviewed - read against the original, not run)
