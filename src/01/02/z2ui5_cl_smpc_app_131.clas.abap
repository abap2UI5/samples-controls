...
" @origin sap.ui.core.sample.BasicThemeParameters - https://sdk.openui5.org/entity/sap.ui.core.theming.Parameters/sample/sap.ui.core.sample.BasicThemeParameters (status: reviewed - read against the original, not run)
