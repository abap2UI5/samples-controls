...
" @origin sap.ui.core.sample.TypeDateAsString - https://sdk.openui5.org/entity/sap.ui.model.type.Date/sample/sap.ui.core.sample.TypeDateAsString (status: reviewed)
