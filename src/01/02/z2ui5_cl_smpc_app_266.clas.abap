...
" @origin sap.ui.layout.sample.SplitterNested1 - https://sdk.openui5.org/entity/sap.ui.layout.Splitter/sample/sap.ui.layout.sample.SplitterNested1 (status: reviewed - read against the original, not run)
