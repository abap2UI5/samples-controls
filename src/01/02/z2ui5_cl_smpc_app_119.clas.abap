...
" @origin sap.ui.layout.sample.FixFlexVertical - https://sdk.openui5.org/entity/sap.ui.layout.FixFlex/sample/sap.ui.layout.sample.FixFlexVertical (status: reviewed - read against the original, not run)
