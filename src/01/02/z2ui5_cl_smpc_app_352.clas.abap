...
CLASS z2ui5_cl_smpc_app_352 IMPLEMENTATION.
  ...
  METHOD on_event.
        ...
        DATA filter LIKE REF TO temp1.
          DATA temp2 LIKE LINE OF filter->values.
          DATA value LIKE REF TO temp2.
  ...
  METHOD filter_apply.
      ...
      DATA t_keep LIKE temp3.
      DATA s_row LIKE LINE OF t_products.
    DATA s_filter LIKE LINE OF t_filters.
      DATA temp4 TYPE string_table.
      DATA value LIKE LINE OF s_filter-values.
      DATA t_selected LIKE temp4.
      DATA temp6 TYPE ty_t_product.
      DATA t_facet_keep LIKE temp6.
      DATA s_product LIKE LINE OF t_products.
        DATA temp7 TYPE string.
        DATA row_value LIKE temp7.
    ...
    LOOP AT t_filters INTO s_filter.
      
      CLEAR temp4.
      
      LOOP AT s_filter-values INTO value WHERE selected = abap_true.
      ...
      LOOP AT t_products INTO s_product.
        
        IF s_filter-type = `Category`.
          temp7 = s_product-category.
        ELSE.
          temp7 = s_product-suppliername.
        ENDIF.
        
        row_value = temp7.
        
        READ TABLE t_selected WITH KEY table_line = row_value TRANSPORTING NO FIELDS.
        temp8 = sy-subrc.
        IF temp8 = 0.
