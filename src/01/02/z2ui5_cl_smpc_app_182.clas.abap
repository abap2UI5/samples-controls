...
" @origin sap.ui.core.sample.TypeTimeAsTime - https://sdk.openui5.org/entity/sap.ui.model.type.Time/sample/sap.ui.core.sample.TypeTimeAsTime (status: reviewed - read against the original, not run)
