...
" @origin sap.ui.core.sample.Html - https://sdk.openui5.org/entity/sap.ui.core.HTML/sample/sap.ui.core.sample.Html (status: reviewed - read against the original, not run)
