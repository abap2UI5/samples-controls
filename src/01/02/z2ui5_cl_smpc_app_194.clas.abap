...
" @origin sap.ui.layout.sample.GridInfo - https://sdk.openui5.org/entity/sap.ui.layout.Grid/sample/sap.ui.layout.sample.GridInfo (status: reviewed - read against the original, not run)
