...
" @origin sap.ui.unified.sample.ColorPicker - https://sdk.openui5.org/entity/sap.ui.unified.ColorPicker/sample/sap.ui.unified.sample.ColorPicker (status: reviewed - read against the original, not run)
