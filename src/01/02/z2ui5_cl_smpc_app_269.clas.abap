...
CLASS z2ui5_cl_smpc_app_269 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    temp4-authorpicurl = `https://upload.wikimedia.org/wikipedia/commons/a/aa/Dronning_victoria.jpg`.
    temp4-type = `Request`.
...
`labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.`.
    ...
    temp4-authorpicurl = `https://upload.wikimedia.org/wikipedia/commons/2/25/George_Washington_as_CIC_of_the_Continental_Army_bust.jpg`.
    temp4-type = `Reply`.
