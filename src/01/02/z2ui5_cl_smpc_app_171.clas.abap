...
CLASS z2ui5_cl_smpc_app_171 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `560.67`.
    temp2-transactionamount-currency = `EUR`.
    temp2-exchange_rate = `1.00000`.
    temp2-amount = `560.67`.
    INSERT temp2 INTO TABLE temp1.
    temp2-expense = `Meals`.
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `180.50`.
    temp2-transactionamount-currency = `USD`.
    temp2-exchange_rate = `0.85654`.
    temp2-amount = `154.72`.
    INSERT temp2 INTO TABLE temp1.
    temp2-expense = `Hotel`.
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `675.00`.
    temp2-transactionamount-currency = `USD`.
    temp2-exchange_rate = `0.85654`.
    temp2-amount = `578.57`.
    INSERT temp2 INTO TABLE temp1.
    temp2-expense = `Taxi`.
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `15`.
    temp2-transactionamount-currency = `USD`.
    temp2-exchange_rate = `0.85654`.
    temp2-amount = `12.86`.
    INSERT temp2 INTO TABLE temp1.
    ...
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `80.00`.
    temp2-transactionamount-currency = `BGN`.
    temp2-exchange_rate = `0.51129`.
    temp2-amount = `40.90`.
    INSERT temp2 INTO TABLE temp1.
    temp2-expense = `Daily allowance Japan`.
    CLEAR temp2-transactionamount.
    temp2-transactionamount-size = `7000`.
    temp2-transactionamount-currency = `JPY`.
