...
" @origin sap.ui.layout.sample.FixFlexMinFlexSize - https://sdk.openui5.org/entity/sap.ui.layout.FixFlex/sample/sap.ui.layout.sample.FixFlexMinFlexSize (status: reviewed - read against the original, not run)
