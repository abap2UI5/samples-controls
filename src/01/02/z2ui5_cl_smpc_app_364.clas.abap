...
" @origin sap.ui.table.sample.TreeTable.BasicODataTreeBinding - https://sdk.openui5.org/entity/sap.ui.table.TreeTable/sample/sap.ui.table.sample.TreeTable.BasicODataTreeBinding (status: reviewed)
