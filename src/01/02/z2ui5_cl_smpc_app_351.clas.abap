...
CLASS z2ui5_cl_smpc_app_351 IMPLEMENTATION.
  ...
  METHOD on_event.
        ...
        DATA area LIKE REF TO temp3.
          DATA temp4 TYPE i.
          DATA temp7 TYPE i.
    DATA temp5 LIKE LINE OF t_areas.
    DATA row LIKE REF TO temp5.
    ...
    CASE client->get_event( ).
      ...
      WHEN `MINSIZE_CHANGED`.
        ...
        LOOP AT t_areas REFERENCE INTO area.
          " the length term, not just the character one - `99999999999` is all
          " digits and overflows CONV i
          
          temp4 = area->minsize_text.
          
          IF area->minsize_text CO ` 0123456789` AND strlen( condense( area->minsize_text ) ) <= 9.
            temp7 = temp4.
          ELSE.
            CLEAR temp7.
          ENDIF.
    ...
    LOOP AT t_areas REFERENCE INTO row.
