...
" @origin sap.ui.layout.sample.HorizontalLayout - https://sdk.openui5.org/entity/sap.ui.layout.HorizontalLayout/sample/sap.ui.layout.sample.HorizontalLayout (status: reviewed - read against the original, not run)
