...
" @origin sap.ui.layout.sample.VerticalLayout - https://sdk.openui5.org/entity/sap.ui.layout.VerticalLayout/sample/sap.ui.layout.sample.VerticalLayout (status: reviewed - read against the original, not run)
