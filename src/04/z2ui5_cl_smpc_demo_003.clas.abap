...
CLASS z2ui5_cl_smpc_demo_003 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    DATA temp4 LIKE t_legend.
    DATA temp5 LIKE LINE OF temp4.
    DATA temp6 LIKE t_members.
    DATA temp7 LIKE LINE OF temp6.
    DATA member_row LIKE LINE OF t_team.
      DATA temp8 TYPE z2ui5_cl_smpc_demo_003=>ty_s_member.
    DATA temp9 LIKE LINE OF t_team.
    DATA person LIKE REF TO temp9.
      DATA temp10 LIKE LINE OF person->t_appointments.
      DATA appointment LIKE REF TO temp10.
    ...
    temp3-personid = `PersonID_1`.
    temp3-name = `John Miller`.
    temp3-role = `Scrum master`.
    temp3-pic = `images/John_Miller.png`.
    
    CLEAR temp1.
    
    temp11-start_at = `2019-10-01T09:00`.
    temp11-end_at = `2019-10-01T11:30`.
    temp11-title = `Team meeting`.
    temp11-info = `Conf. room 1`.
    temp11-pic = ``.
    temp11-type = `Type01`.
    temp11-tentative = abap_true.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-04T09:00`.
    temp11-end_at = `2019-10-04T17:30`.
    temp11-title = `Face to face`.
    temp11-info = `Room 13`.
    temp11-pic = `images/Donna_Moore.jpg`.
    temp11-type = `Type05`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-07T09:00`.
    temp11-end_at = `2019-10-07T11:30`.
    temp11-title = `Team meeting`.
    temp11-info = `Conf. room 1`.
    temp11-pic = ``.
    temp11-type = `Type01`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-11T09:00`.
    temp11-end_at = `2019-10-11T17:30`.
    temp11-title = `Face to face`.
    temp11-info = `Room 13`.
    temp11-pic = `images/Donna_Moore.jpg`.
    temp11-type = `Type05`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-10T09:00`.
    temp11-end_at = `2019-10-10T17:00`.
    temp11-title = `Show and tell`.
    temp11-info = ``.
    temp11-pic = ``.
    temp11-type = `Type08`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-16T09:00`.
    temp11-end_at = `2019-10-16T11:30`.
    temp11-title = `Team meeting`.
    temp11-info = `Conf. room 1`.
    temp11-pic = ``.
    temp11-type = `Type01`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-17T14:00`.
    temp11-end_at = `2019-10-17T16:00`.
    temp11-title = `Release plan presentation`.
    temp11-info = `Conf. room 1`.
    temp11-pic = `sap-icon://legend`.
    temp11-type = `Type08`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-18T09:30`.
    temp11-end_at = `2019-10-18T12:00`.
    temp11-title = `Training`.
    temp11-info = `Training hall`.
    temp11-pic = `sap-icon://education`.
    temp11-type = `Type05`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-21T09:00`.
    temp11-end_at = `2019-10-21T11:30`.
    temp11-title = `Team meeting`.
    temp11-info = `Conf. room 1`.
    temp11-pic = ``.
    temp11-type = `Type01`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-23T10:00`.
    temp11-end_at = `2019-10-23T13:00`.
    temp11-title = `Company security`.
    temp11-info = `Conf. room 3`.
    temp11-pic = `sap-icon://legend`.
    temp11-type = `Type08`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-24T09:30`.
    temp11-end_at = `2019-10-24T13:00`.
    temp11-title = `Dentist`.
    temp11-info = ``.
    temp11-pic = `sap-icon://offsite-work`.
    temp11-type = `Type09`.
    temp11-tentative = abap_false.
    INSERT temp11 INTO TABLE temp1.
    temp11-start_at = `2019-10-29T14:00`.
    temp11-end_at = `2019-10-29T15:00`.
    temp11-title = `Face to face`.
    temp11-info = `Room 13`.
    temp11-pic = `images/Donna_Moore.jpg`.
    temp11-type = `Type05`.
    ...
    temp13-type = `Type05`.
    INSERT temp13 INTO TABLE temp12.
    temp3-t_headers = temp12.
    INSERT temp3 INTO TABLE temp2.
    temp3-personid = `PersonID_2`.
    temp3-name = `Donna Moore`.
    temp3-role = `Team manager`.
    temp3-pic = `images/Donna_Moore.jpg`.
    ...
    temp17-type = `Type05`.
    INSERT temp17 INTO TABLE temp16.
    temp3-t_headers = temp16.
    INSERT temp3 INTO TABLE temp2.
    temp3-personid = `PersonID_3`.
    temp3-name = `Elena Petrova`.
    temp3-role = `Designer`.
    temp3-pic = `images/Elena_Petrova.jpg`.
    ...
    temp21-type = `Type05`.
    INSERT temp21 INTO TABLE temp20.
    temp3-t_headers = temp20.
    INSERT temp3 INTO TABLE temp2.
    temp3-personid = `PersonID_4`.
    temp3-name = `John Li`.
    temp3-role = `Developer`.
    temp3-pic = `images/John_Li.jpg`.
    ...
    temp5-text = `Team meeting`.
    temp5-type = `Type01`.
    INSERT temp5 INTO TABLE temp4.
    temp5-text = `Personal`.
    temp5-type = `Type05`.
    INSERT temp5 INTO TABLE temp4.
    temp5-text = `Discussions`.
    temp5-type = `Type08`.
    INSERT temp5 INTO TABLE temp4.
    temp5-text = `Out of office`.
    temp5-type = `Type09`.
    INSERT temp5 INTO TABLE temp4.
    temp5-text = `Private meeting`.
    temp5-type = `Type03`.
    INSERT temp5 INTO TABLE temp4.
    t_legend = temp4.
    ...
    LOOP AT t_team INTO member_row.
      ...
      CLEAR temp8.
      temp8-key = member_row-name.
      temp8-text = member_row-name.
      INSERT temp8 INTO TABLE t_members.
    ENDLOOP.
